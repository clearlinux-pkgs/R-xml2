...
Version  : 1.2.4
Release  : 71
URL      : https://cran.r-project.org/src/contrib/xml2_1.2.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xml2_1.2.4.tar.gz
Summary  : Parse XML
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583874883
