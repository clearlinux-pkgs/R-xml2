...
Version  : 1.3.0
Release  : 74
URL      : https://cran.r-project.org/src/contrib/xml2_1.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xml2_1.3.0.tar.gz
Summary  : Parse XML
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585750896
